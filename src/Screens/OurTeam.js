      ...
      <div class="container con-bg">
        ...
        <div class="row featurette">
          <div class="col-md-7 margin-auto-class padding-class-40">
            <h2 class="featurette-heading fw-normal lh-1">Harshit Sharma </h2>
            <p class="lead blue-text">As the team lead, Harshit played a pivotal role in developing the frontend of the website. Using technologies like React, HTML, CSS, and JavaScript, Harshit focused on crafting an intuitive and visually appealing user interface, ensuring a seamless experience for users.</p>
          </div>
          <div class="col-md-5">
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2 margin-auto-class padding-class-40">
            <h2 class="featurette-heading fw-normal lh-1">Rajat Bansal </h2>
        ...
        <div class="row featurette">
          <div class="col-md-7 margin-auto-class padding-class-40">
            <h2 class="featurette-heading fw-normal lh-1">Vaibhav Pandey</h2>
        ...
        <div class="row featurette">
          <div class="col-md-7 order-md-2 margin-auto-class padding-class-40">
            <h2 class="featurette-heading fw-normal lh-1">Vinayak </h2>
            <p class="lead blue-text"> Vinayak worked alongside Harshit as a frontend engineer, supporting the development of interactive elements and ensuring responsive design, further enhancing the website’s user experience.</p>
          </div>
          <div class="col-md-5 order-md-1">
